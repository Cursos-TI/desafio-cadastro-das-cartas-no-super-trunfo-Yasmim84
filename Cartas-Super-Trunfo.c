...
int main() {
    ...
    superPoder1 = (float)populacao1 + area1 + pib1 + p_turistico1 + densidade1 + pib_per_capita1;
    superPoder2 = (float)populacao2 + area2 + pib2 + p_turistico2 + densidade2 + pib_per_capita2;
